...
def create_log_dirs(config):
    ...
    params = f"La{config.lambda_action_cost}_Lt{config.lambda_temporal}_Ls{config.lambda_spatial}_Ar{config.action_repeat}_Bl{config.batch_length}_H{config.horizon}"
